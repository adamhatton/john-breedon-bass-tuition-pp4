...
class LearnerProfileForm(forms.ModelForm):
    ...
    disabled_layout = Layout(
        ...
        Div(
            HTML('<a class="btn btn-secondary hidden" id="button-id-cancel" href="{% url "learner_account" %}">&laquo; Cancel</a>'),
    ...
    enabled_layout = Layout(
        ...
        Field('about'),
        Div(
            HTML('<a class="btn btn-secondary" id="button-id-cancel" href="{% url "learner_account" %}">&laquo; Cancel</a>'),
